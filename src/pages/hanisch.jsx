...
export default function Hanisch() {
  return (
    <>
      <Menu />
      ...
      <section className={styles.background}>
        <div className={styles.interno2}>
          <img src="/static/images/cases/hanisch-01.png" alt="" />

          <span style={{margin:"2rem 0rem"}}></span>

        
          <img src="/static/images/cases/hanisch-02.png" alt="" />
         

          <span style={{ margin: "2rem 0rem" }}></span>
          
      
          <img src="/static/images/cases/hanisch-03.png" alt="" />
          
          <span style={{ margin: "2rem 0rem" }}></span>
          
      
            <img src="/static/images/cases/hanisch-04.png" alt="" />
